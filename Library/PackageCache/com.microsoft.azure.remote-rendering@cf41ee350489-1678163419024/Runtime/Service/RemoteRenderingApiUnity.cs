...
namespace Microsoft.Azure.RemoteRendering
{
    ...
    public partial struct SpatialQuery
    {
        ...
        /// <summary>
        /// The bounds in worldspace to perform the query.
        /// </summary>
    ...
    internal struct RendererInitOptionsAbi
    {
        ...
        /// <summary>
        /// Forces all transparent <see cref="PbrMaterial"/>s and <see cref="ColorMaterial"/>s to write depth.
        /// </summary>
        [MarshalAs(UnmanagedType.U1)]
    ...
    public partial class GraphicsBinding
    {
        ...
        /// <remarks>
        /// <para>
        /// A <see cref="Result.NotSupported"/> error occurs if <see cref="PoseMode.Passthrough"/>
    ...
    public partial class SpatialQueryResult
    {
        ...
        public System.Collections.Generic.IReadOnlyList<Microsoft.Azure.RemoteRendering.MeshComponent> Overlaps
        {
            get
            {
                ...
                result = result_array?.Select(handle => new Microsoft.Azure.RemoteRendering.MeshComponent(handle, transfer:true)).ToArray() ?? Array.Empty<Microsoft.Azure.RemoteRendering.MeshComponent>();
                return result;
            }
        }
